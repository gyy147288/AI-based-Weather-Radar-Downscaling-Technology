...
def interpolate_layer(data, lower_idx, upper_idx, new_idx, new_angle, lower_angle, upper_angle):
    ...
    lower_valid = (lower_layer > FILL_VALUE)
    upper_valid = (upper_layer > FILL_VALUE)
...
#训练其他仰角的时候需要修改load_and_process_data函数的参数
...
def process_interpolation_data(root_path, filename_ZH, filename_CC):    #插值
    ...
    # 利用 cc 数据质控
    filtered_zh = data_ZH.where(data_CC > 800, -32768)
